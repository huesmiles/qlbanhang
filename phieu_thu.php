			...
			<form action="" method="POST">
				<div class="row">
					...
					<div class="col-sm-6" ng-show="mkh">
						<H3>
							<FONT color="red">{{kh_da_chon.ten_kh}}</FONT>
						</H3>
...
$bangdsnv = mysqli_query($conn, "SELECT pt.ma_phieuthu,pt.ngay_thu,pt.tien_thu,pt.noi_dung,pt.ma_kh,pt.phanloaithuchi,kh.ten_kh from phieu_thu pt join khach_hang kh on kh.ma_kh = pt.ma_kh where pt.phanloaithuchi = 'Phiếu thu'");
?>
<div class="container-fluid" style="margin-top: 20px">
	<div class="card text-dark" style="max-width: 100%;">
						...
						<?php foreach ($bangdsnv as $key => $dsnv) : ?>
							<tr>
								...
								<td style="text-align: center;">
									<a href="phieuthu_sua.php?ma_phieuthu=<?php echo $dsnv['ma_phieuthu'] ?>" title="Sửa">
										<i class="far fa-edit" style="color: green"></i> | </a>
									<a href="phieuthu_xoa.php?ma_phieuthu=<?php echo $dsnv['ma_phieuthu'] ?>" title="Xóa">
