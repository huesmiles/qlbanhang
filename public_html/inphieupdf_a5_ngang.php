...
?>
  ...
  <table class="TableData1">
    <tr>
      <td style="width:45%;">
        <div><h2>HÓA ĐƠN BÁN HÀNG</h2></div>
...
<table class="TableData">
  ...
  <table class="TableData">
    ...
    <tr>
      <td colspan="5" style="text-align: right;"><B>Tiền Ship </B></td>
      <td style="text-align: right;"><?php echo number_format($hien['tien_ship_dh']) ?></td>
    </tr>
     <tr>
      <td colspan="5" style="text-align: right;"><B>Tổng tiền đơn hàng</B></td>
      <td style="text-align: right;"><b><?php echo number_format($tongsotien - $hien['tien_km_don_hang']+$hien['tien_ship_dh'] ) ?></b></td>
    </tr>
  </table>
