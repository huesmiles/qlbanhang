				...
				<tbody>
					...
					<tr>
						<td style="text-align: center;">
							<a href="nhacc_sua.php?ma_kh=<?php echo $dsnv['ma_kh'] ?>" title="Sửa"><i class="fa fa-address-book" aria-hidden="true" style="color: orange"></i></a>
						</td>
<td style="text-align: center;">
							<a href="nhacc_xoa.php?ma_kh=<?php echo $dsnv['ma_kh'] ?>" title="Xóa"><i class="fa fa-delete" aria-hidden="true" style="color: orange"></i></a>
						</td>
