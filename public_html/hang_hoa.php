		...
		<tbody>
			...
			<tr>
				<td style="text-align: center;">
					<a href="hanghoa_sua.php?ma_hh=<?php echo $dsnv['ma_hh'] ?>" title="Sửa"><i class="fa fa-address-book" aria-hidden="true" style="color: orange"></i></a>	
				</td>
				<td style="text-align: center;">
					<a href="hanghoa_xoa.php?ma_hh=<?php echo $dsnv['ma_hh'] ?>" title="Xóa"><i class="fa fa-address-book" aria-hidden="true" style="color: orange"></i></a>	
				</td>
