	...
	<div class="card text-dark" style="max-width: 100%;">
		...
		<div class="card-body">				
			<form action="" method="POST">
				<input type="number" name="ngay_bd" placeholder="KH sinh nhật từ tháng">
				<input type="number" name="ngay_kt" placeholder="đến tháng">
			...
			<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
				...
				<tbody>
					...
					<tr>
						...
						<td><?php echo $dsnv['facebook'] ?></td>
						<td><?php echo $dsnv['zalo'] ?></td>
						<td><?php echo $dsnv['email'] ?></td>
						<td><?php echo $dsnv['sinhnhat'] ?></td>
					</tr>
					<?php endforeach; ?>
				</tbody>
			</table>
