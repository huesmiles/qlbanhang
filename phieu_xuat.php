...
$ngaynow = date('Y-m-d');
$quaylai = 0;
if (isset($_SESSION['kh_px'])) {
	$chonkh = $_SESSION['kh_px'];
}
$hanghoa = isset($_SESSION['xuathh'])  ? $_SESSION['xuathh'] : [];
...
if (isset($_POST['btnin'])) {
	unset($_SESSION['xuathh']);
	unset($_SESSION['kh_px']);
...
<div class="container-fluid" style="margin-top: 20px">
	<div class="card text-dark" style="max-width: 100%;">
		<div class="card-header bg-dark" style="color: white; padding-top: 10px">PHIẾU XUẤT HÀNG HÓA</div>
		<div class="card-body">
			<div class="row">
				...
				<div class="col-sm-8" style="background-color: #F7F7F7; padding-top: 20px;">
					<div class="row">
						<div class="col-sm-12">
							<form action="chon_hh_xk.php" method="POST">
							...
							<form action="chon_hh_xk.php" method="POST">
										...
										<tbody>
											...
											?>
												<tr>
													...
													<td class="text-right">
														<a href="chon_hh_xk.php?ma_hh=<?php echo $hh['ma_hh'] ?>&hd2=del1">(-)</a>
														<input name="sl[<?php echo $hh['ma_hh']; ?>]" value="<?php echo $hh['sl'] ?>" class="text-right" size="2">
														<a href="chon_hh_xk.php?ma_hh=<?php echo $hh['ma_hh'] ?>&hd1=add1">(+)</a>
													</td>
													...
													<td>
														<a href="chon_hh_xk.php?ma_hh=<?php echo $hh['ma_hh'] ?>&hd=xoa">(-)</a>
													</td>
												</tr>
											<?php endforeach; ?>
										</tbody>
								...
								<?php if ($ad['cap_bac'] == 'quan_tri') : ?>
									<div style="text-align: right;">
										<h4>TỔNG TIỀN HÀNG = <?php echo number_format($tongtienhang) . ' VNĐ'; ?></h4>
									</div>
								<?php endif ?>
								...
								<tbody>
									<tr ng-repeat="kh in khs">
										<td style="text-align: left;">
											<a href="chon_kh_px.php?ma_kh={{kh.ma_kh}}" class="btn btn-sm btn-success">Chọn</a>
										</td>
										<td>{{kh.ten_kh}}</td>
										<td>{{kh.mobile}}</td>
										<td>{{kh.dia_chi}}</td>
