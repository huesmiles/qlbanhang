			...
			<form action="" method="POST">
				<div class="row">
						...
						<div class="col-sm-6" ng-show="mncc">
							<H3><FONT color="red">{{ncc_da_chon.ten_kh}}</FONT></H3>
						...
						<?php foreach ($bangdsnv as $key => $dsnv): ?>
							<tr>
								...
								<td style="text-align: center;">
									<a href="phieuchi_sua.php?ma_phieuthu=<?php echo $dsnv['ma_phieuthu'] ?>" title="Sửa"> <i class="fa fa-pencil-square-o fa-1x" aria-hidden="true"style="color: black"></i> | </a>
									<a href="phieuchi_xoa.php?ma_phieuthu=<?php echo $dsnv['ma_phieuthu'] ?>" title="Xóa"> <i class="fa fa-times fa-1x" aria-hidden="true" style="color: red"></i></a></td>
