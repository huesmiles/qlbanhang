		...
		<div class="card-body">
			<div class="row">
				...
				<div class="col-sm-4" style="background-color: #F0F7FC; padding-top: 20px;">
					<div class="row">
						<div class="col-sm-12">
							<input type="text" class="form-control" ng-model="tenncc" ng-keyup="get_ncc()" placeholder="Nhập tên/mobile nhà cung cấp">
							<table class="table table-bordered table-inverse table-hover">
								<!-- <a class="btn btn-sm btn-secondary btn-block" style="color: white">Là khách mới bạn bỏ qua ô này</a> -->
								<tbody>
									<tr ng-repeat="ncc in nccs">
										<td style="text-align: left;">
											<a href="chon_kh_pn.php?ma_kh={{ncc.ma_kh}}" class="btn btn-sm btn-success">Chọn</a>
										</td>
										<td>{{ncc.ten_kh}}</td>
										<td>{{ncc.mobile}}</td>
										<td>{{ncc.dia_chi}}</td>
