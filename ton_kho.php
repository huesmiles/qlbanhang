...
<?php 
$sqlslx = mysqli_query($conn,"SELECT h.ma_hh,h.ten_hh, sum(ctx.slx) as sumslx, sum(ctn.sln) as sumsln,(ctn.t_don_gia_nhap/ctn.sln) as don_gia_nhap FROM hang_hoa h
LEFT JOIN (
